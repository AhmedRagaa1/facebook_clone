...
class VideoScreen extends StatelessWidget {
              ...
              }else
              {
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return (snapshot.data!.docs[index]['postVideo'] != '')? buildVideoItem(snapshot, index, context, cubit) : const SizedBox(height: 0,);
                  },
                  separatorBuilder: (context, index) =>(snapshot.data!.docs[index]['postVideo'] != '')? Container(
                    height: 12.h,
  ...
  Column buildVideoItem(AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot, int index, BuildContext context, HomeCubit cubit) {
    return Column(
